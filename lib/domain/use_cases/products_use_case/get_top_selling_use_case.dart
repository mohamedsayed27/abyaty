...
class GetTopSellingProductUseCase extends BaseUseCase<GetNotPaginatedProductEntity, NoParameters> {
  final ProductBaseRepository productBaseRepository;

  GetTopSellingProductUseCase({required this.productBaseRepository});

  @override
  Future<Either<ErrorException, GetNotPaginatedProductEntity>> call(NoParameters parameters) async {
    return await productBaseRepository.getTopSellingProducts();
  }
